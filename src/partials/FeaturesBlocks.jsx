      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Our Core Team</h2>
            <p className="text-xl text-gray-400">Be part of the Coding Club and collaborate with passionate individuals who share your love for technology and innovation!</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Dr. Sagar B M</h4>
              <p className="text-lg text-gray-400 text-center">Mentor and Chief Advisor. HoD, Dept of Information Science and Engineering</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Dr Padmashree T</h4>
              <p className="text-lg text-gray-400 text-center">Project manager and event coordinator. Associate Professor, Dept of Information Science and Engineering </p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Gaurav Pai </h4>
              <p className="text-lg text-gray-400 text-center">Ex- President, Coding Club RVCE. Student of Dept of Computer Science and Engineering</p>
            </div>
